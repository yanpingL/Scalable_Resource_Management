...
namespace {
// Parses cached resource JSON and ignores invalid cache entries.
...
// Builds a resource-service JSON error response from a standard exception.
...
// Builds a resource-service JSON error response from an unknown exception.
